...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.item == self.itemsArray.count)
    {
        ...
        [cell.textLabel setText:@"Внимание. Создатели программы NAKED CHINESE не имеют цели оскорбления чьего-либо достоинства, и не являются сторонниками использования нецензурной лексики. Мы любим и уважаем и Китай, и китайский язык. Цель этой программы не научить людей оскорблять друг друга, а научить понимать, когда оскорбляют вас. Мы хотим защитить вас и увести от конфликтных ситуаций. Мы призываем всех к использованию только нормативной лексики, и к мирному решению все возникающих проблем.  "];
